"""
Headless Rainbow Training (no demo windows)
...
def train(num_episodes: int = 10000):
    """Train Rainbow without demo windows."""
    ...
    print("Rainbow: Filling replay buffer...")
    state, _ = env.reset()
    for step in range(10_000):
        ...
        if (step + 1) % 2000 == 0:
            print(f"  Rainbow buffer: {step + 1}/10000")

    print(f"Rainbow: Buffer filled. Starting training for {num_episodes} episodes!")
    print("-" * 60)
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if avg_reward > best_avg_reward and episode >= 100:
            ...
            print(f"  -> New best! Saved rainbow_best.pth")
    ...
    print(f"Rainbow: Training complete! Total episodes: {episode}")
